...
- LANGUAGE: Very simple vocabulary, short sentences, fun analogies, and friendly emojis \u{1F31F}!
...
function formatContents(message, history) {
  const contents = [];
          ...
          properties: {
            ...
            adaptations: {
              ...
              properties: {
                ...
                middle: { type: import_genai.Type.STRING },
                high_school: { type: import_genai.Type.STRING },
                university: { type: import_genai.Type.STRING }
              },
